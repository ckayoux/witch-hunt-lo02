 ...
 * <p>Represents a {@link fr.sos.witchhunt.model.players.Player#getHand() player's hand}, {@link fr.sos.witchhunt.controller.Tabletop#getPile() the common pile of discarded cards}
 ...
 * <p>When {@link #reset()}, returns this deck's content to the {@link fr.sos.witchhunt.controller.Tabletop#getAllCardsPile() game's pile of all existing cards}.</p>
 * 
 * @see RumourCard
...
public final class RumourCardsPile implements Resettable {
	...
	/**
	 * <b>Returns this deck's content to the {@link fr.sos.witchhunt.controller.Tabletop#getAllCardsPile() game's pile of all existing cards}.</b>
	 * <p>Call this method only on players' decks and on the common pile of discarded cards at the end of a {@link fr.sos.witchhunt.controller.Round Round}.</p>
	 */
	@Override
	public void reset() {
	...
	/**
	 * <b>Requests the view to display the content of this deck, through a {@link fr.sos.witchhunt.DisplayMediator DisplayMediator}.</b>
	 ...
	 * @see fr.sos.witchhunt.DisplayMediator#displayCards(RumourCardsPile, boolean) DisplayMediator::displayCards(RumourCardsPile,boolean)
	 */
